...
// Entraînements
// =============================
DLLEXPORT unsigned char train_linear_classification(LinearModel* model, float* dataset_inputs, float* dataset_expected_outputs, uint32_t dataset_size, float alpha, uint32_t epochs, float* loss_history);
